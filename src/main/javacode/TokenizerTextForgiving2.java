...
public final class TokenizerTextForgiving2 implements Tokenizer
{
    ...
    public TokenizerTextForgiving2(PeekReader reader) {
        this(reader, false);
    }

    public TokenizerTextForgiving2(PeekReader reader, boolean lineMode) {
        this.reader = reader;
...
//        System.err.println(",,,is:"+t);
    ...
    private String ignoredParts = "";

    public String getIgnoredParts() {
        return ignoredParts;
    }
    ...
    public void skipLine() {
        ...
        for (;;) {
            ...
            if ( ch == EOF || isNewlineChar(ch) )
                break;
            skippedPart.append((char)reader.readChar());
        }
        ignoredParts +=  skippedPart.toString();
    }
